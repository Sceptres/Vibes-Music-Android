...
class ImportSongsScreenViewModel(application: Application, private val globalScope: CoroutineScope) : AndroidViewModel(application) {
    ...
    fun ActivityFilesLauncher(
        ...
        return rememberLauncherForActivityResult(contract = _root_ide_package_.com.aaa.vibesmusic.ui.screens.songimport.result.ImportSongsActivityResultContract()) { uris ->
